...
import NewRosterPage from "./new"; // Correct path for new roster page
import PastRosterPage from "./completed"; // Correct path for past roster page
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <div className="p-4">
            {selectedTab === "new" && <NewRosterPage />}
            {selectedTab === "completed" && <PastRosterPage />}
          </div>
        </Tabs>
      </div>
    </div>
