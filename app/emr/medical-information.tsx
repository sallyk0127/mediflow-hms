...
export default function MedicalInformation() {
  ...
  const handleUpdate = async () => {
    const medicalData = {
      history: document.querySelector("textarea[placeholder='Enter medical history']").value,
      medications: document.querySelector("textarea[placeholder='Enter current medications']").value,
  ...
  const handleDelete = () => {
    document.querySelector("textarea[placeholder='Enter medical history']").value = "";
    document.querySelector("textarea[placeholder='Enter current medications']").value = "";
    setAllergyInput("");
    setConditionInput("");
